...
export default function GoalApp() {
  ...
  return (
    <div>
      <CreateGoal
        goal={goalInput} // 목표 입력 상태 전달
        onChange={handleInputChange} // 입력 변경 핸들러 전달
        onCreate={handleCreate} // 목표 추가 핸들러 전달
      />
      <GoalList 
        goals={goals} // 목표 목록 상태 전달
        onRemove={handleRemove} // 목표 제거 핸들러 전달
        onToggle={handleToggle} // 목표 활성 상태 변경 핸들러 전달
      />
    </div>
  )
}
