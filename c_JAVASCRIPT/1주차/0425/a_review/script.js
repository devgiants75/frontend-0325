...
let score ;
let hasTrophy; // 사용자로부터 트로피를 가지고 있는지 답변을 받아 변수에 저장 (yes/no의 데이터 입력받기 - yes와 동일할 경우 해당 변수에 true값 저장)
let gameWins;

let isEligible;  // 위의 모든 조건을 만족할 경우 해당 변수에 true값 저장
